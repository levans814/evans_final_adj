...
Name<- data.frame(names = c("Eric Schmitt", "Vicky J. Hartzler", "Billy Long", "Lucas Kunce", "Scott Sifton", "Eric Greitens", "Mark T. Mccloskey", "Spencer Ross Toder", "Jewel William Kelly Jr.", "Timothy Jacob Shepard", "Gena Ross", "Nicholas Crane Strauss", "Roy Blunt"))
