...
server <- function(input, output){
  ...
  theme_bw(base_size = 16))
   ...
   output$demPlot <- renderPlot(ggplot(dem_cand_totals, aes(reorder(dem_cand_totals$cand_name, dem_cand_totals$total))) +
  geom_bar(aes(weight = dem_cand_totals$total), fill = "#173F5F") + 
  coord_flip() +
  ggtitle("Total candidate contributions") +
  xlab("Candidate") +
  ylab("Sum of contributions") +
  theme_bw(base_size = 16))
   ...
   output$repPlot <- renderPlot(ggplot(rep_no_blunt, aes(reorder(rep_no_blunt$cand_name, rep_no_blunt$total))) +
  geom_bar(aes(weight = rep_no_blunt$total), fill = "#ED5533") + 
  coord_flip() +
  ggtitle("Total candidate contributions") +
  xlab("Candidate") +
  ylab("Sum of contributions") +
...
output$unkPlot <- renderPlot(ggplot(unk_cand_totals, aes(reorder(unk_cand_totals$cand_name, unk_cand_totals$total))) +
  geom_bar(aes(weight = unk_cand_totals$total), fill = "#F6D55C") + 
  coord_flip() +
  ggtitle("Total candidate contributions") +
  xlab("Candidate") +
  ylab("Sum of contributions") +
